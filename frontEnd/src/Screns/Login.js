...
export default function Login() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:4000/users/login', object,{
        headers:{
      ...
      let login = localStorage.setItem('isLoggedIn', true); // Set a flag for login state
